...
//,{D(jjDSTD),      DSTD_CMD,       LIST_CMD,      IDEAL_CMD,  INT_CMD, NO_PLURAL | NO_RING}
,{D(jjDSTD),      DSTD_CMD,       QRING_CMD,      IDEAL_CMD,  INT_CMD, NO_PLURAL | NO_RING},{D(jjVARSTR2),   VARSTR_CMD,     STRING_CMD,     RING_CMD,   INT_CMD, ALLOW_PLURAL |ALLOW_RING}
